package com.legalmatch.exam.repository.specifications;

import com.legalmatch.exam.model.Employee;
import com.legalmatch.exam.repository.criteria.SearchCriteria;
...
public class EmployeeSpecification implements Specification<Employee> {
    ...
    public EmployeeSpecification with(String key, Object value, SearchOperation operation) {
        list.add(SearchCriteria.builder().key(key).value(value).operation(operation).build());
        return this;
    }
